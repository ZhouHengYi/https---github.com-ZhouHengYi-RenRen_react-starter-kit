    ...
    return (
            <section className="open-class">
                <div className="section-title">
                    <h1>公开课</h1>
                    <ul className="filter">
                        <li data-content="#allClass">全部</li>
                        <li data-content="#UKClass">英国</li>
                ...
                <div className="open-class-content">
                                ...
                                <div className="evaluation-list">
                                    <div className="evaluation-item">
                                        <div className="head-pic">
                                            <img src="http://new.rrliuxue.com/WebResources/Default/images/open-class/head-pic1.png" />
                                        </div>
                                    ...
                                    <div className="evaluation-item">
                                        <div className="head-pic">
                                            <img src="http://new.rrliuxue.com/WebResources/Default/images/open-class/head-pic2.png" />
                                        </div>
                                        <div className="evaluation-info">
                            ...
                            <div className="class-list">
                                <div className="class-item">
                                    ...
                                    <div className="class-desc">
                                        ...
                                        <div className="class-info">预约：<span className="population">1860</span> 人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span className="date">4月19日  19:30</span></div>
                    ...
                    <div className="content" id="UKClass">
                        <div className="first-box">
                            <div className="search-class">
                                <div className="search-class-input" data-country="UK">
                                    <input type="text" placeholder="搜索课程" />
                                    <button type="button">&nbsp;</button>
                                    <div className="clear"></div>
                                </div>
                        ...
                        <div className="list-box">
                            ...
                            <div className="more"><a href="/open-class.aspx?country=UK">查看全部 ></a></div>
                        </div>
                    </div>
                </div>
            </section>
